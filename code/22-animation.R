...
# Use the Warming Stripes from Day 20, and animate that
...
p = usa_ne_anomaly_processed %>% 
  ...
  annotate("text", label = "github.com/kaizadp
           ...
           #30DayChartChallenge 2021: 22-Animation", 
...
p_anim = 
  ...
  labs(title = '{1894+frame}')

animate(
  p_anim,
  width = 780, height = 300, res = 150
)

anim_save("images/22-animation.gif")
